...
```
git clone https://github.com/amrit110/CppND-Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:amrit110/CppND-Route-Planning-Project.git --recurse-submodules
```
